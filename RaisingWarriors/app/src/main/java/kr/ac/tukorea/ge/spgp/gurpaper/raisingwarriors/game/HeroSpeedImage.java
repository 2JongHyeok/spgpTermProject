...
public class HeroSpeedImage implements IGameObject {
    ...
    public HeroSpeedImage(int mipmapId, float right, float top, float width) {
    ...
    public void setSpeed(int m_money) {
        this.speed = m_money;
    }
    @Override
