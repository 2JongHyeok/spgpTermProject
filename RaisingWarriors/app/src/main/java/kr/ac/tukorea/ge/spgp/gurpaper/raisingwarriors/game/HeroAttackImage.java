...
public class HeroAttackImage implements IGameObject {
    ...
    public HeroAttackImage(int mipmapId, float right, float top, float width) {
    ...
    public void setDamage(int m_money) {
        this.damage = m_money;
    }
    @Override
