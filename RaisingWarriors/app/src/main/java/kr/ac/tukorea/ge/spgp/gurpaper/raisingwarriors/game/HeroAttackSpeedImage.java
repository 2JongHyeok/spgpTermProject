...
public class HeroAttackSpeedImage implements IGameObject {
    ...
    public HeroAttackSpeedImage(int mipmapId, float right, float top, float width) {
    ...
    public void setAttackSpeed(int m_money) {
        this.attackSpeed = m_money;
    }
    @Override
